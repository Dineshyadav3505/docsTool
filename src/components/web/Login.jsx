...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-martel bg-[#f1f4c6] text-black dark:bg-[#212121] dark:text-white">
      <div className="shadow-lg rounded-lg p-8 max-w-md w-full bg-[#edf1b4] dark:bg-[#3e3e3e]">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.email ? 'border-red-500' : ''}`}
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.password ? 'border-red-500' : ''}`}
